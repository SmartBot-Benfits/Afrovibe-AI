...
const TracksView = () => {
    ...
    return (
      <>
          ...
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={removeLastCharacter('View tracks')} main>
                <BaseButton
                  color='info'
                  label='Edit'
                ...
                <>
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {tracks.comments_track && Array.isArray(tracks.comments_track) &&
                        ...
                        {!tracks?.comments_track?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
