...
export const deleteItem = createAsyncThunk('comments/deleteComments', async (id: string, { rejectWithValue }) => {
    try {
...
export const create = createAsyncThunk('comments/createComments', async (data: any, { rejectWithValue }) => {
    try {
...
export const update = createAsyncThunk('comments/updateComments', async (payload: any, { rejectWithValue }) => {
    try {
